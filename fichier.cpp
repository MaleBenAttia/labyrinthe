    ...
    do
{
  ...
  string nomFichier = "dic.txt"; // Remplacez par le nom de votre fichier
...
do
{
    ...
    {
         cout << "Erreur : La position de départ doit être dans les limites du labyrinthe. Veuillez réessayer.\n";
    }
    if (Matric[n1][m1] =='1'){
